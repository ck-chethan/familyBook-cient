        ...
        return (<>
            <div className="birthdayContainer">
                ...
                <span className="birthdayText">
                    <b>Jhimmy</b> and <b>3 other friends</b> have a birthday today.
                </span>
            </div>
    ...
    const ProfileRightbar = () => {
        return (
            <>
                ...
                <h4 className="rightbarProfleTitle">User Information</h4>
                ...
                <h4 className="rightbarProfleTitle">User Friends</h4>
